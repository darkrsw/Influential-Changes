...
change in this paper as a {\em source code change} which may induce significant (i.e., visible) changes
...
{\em change behaviour}: we use this expression to refer to the observable metrics associated with a series of changes in a software project. The average delay between two commits (i.e., the rhythm of commits) is part of an example of change behaviour observation.
