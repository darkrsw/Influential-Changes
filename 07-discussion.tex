...
approved by developers. Furthermore, CC and NL feature are project-specific and may not be 
applied to cross-project prediction. Our experiment includes subjects in which we can find sufficient
number of data to extract features. However, some project might have enough history to compute
features. Our future work includes extracting more features for cross-project IC prediction.
