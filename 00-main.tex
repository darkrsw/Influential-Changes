...
Our goal is to 1) identify existing influential changes (ICs) in software projects, 2) understand their characteristics, and 3) build a classification model of ICs, based on the characteristics, to improve a further development process.
%
...
The experiment results show that our classification model achieves overall with random samples
