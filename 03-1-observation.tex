...
We then set to assess the quality of the metrics used in our observational
study. We manually checked all potential influential changes yielded by the
systematic analysis (240, 451, and 99 commits shown in Tables~\ref{tab:blocking}, \ref{tab:isolated}, and~\ref{tab:referenced}, respectively -- i.e., 785 distinct commits as shown in Table~\ref{tab:qualitative}). We further randomly pick change commits from each project
