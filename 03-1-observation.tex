...
study. To that end, we must compute the rate of influential changes among the changes that
...
systematic analysis are indeed acceptable as influential. We further randomly pick change commits from each project
