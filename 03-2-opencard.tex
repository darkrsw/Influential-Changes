...
\begin{itemize}
	...
	\item Developers also suggested two other categories of influential changes: {\em Documentation changes} and {\em Design-phase changes}. The latter, however, is challenging to capture in source code repository artefacts, while the former is not relevant to our study which focuses on source code changes.
\end{itemize}
